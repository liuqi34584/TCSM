...
def train_meanteacher(labeled_trainloader, unlabeled_trainloader, model, ema_model, optimizer,
    ...
    for batch_idx in range(args.val_iteration):
        ...
        # 打印之后inputs_x是一个tensor张量（有正负两百以内的值），这里device='cuda:0'
